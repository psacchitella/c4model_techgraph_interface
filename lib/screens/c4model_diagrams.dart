...
void main() => runApp(const C4ModelDiagram());

class C4ModelDiagram extends StatefulWidget {
  const C4ModelDiagram({Key? key}) : super(key: key);

  @override
  _C4ModelDiagramState createState() => _C4ModelDiagramState();
}

class _C4ModelDiagramState extends State<C4ModelDiagram> {
...
class C4ModelData {
  ...
  C4ModelData.fromJson(Map<String, dynamic> json)
...
mixin C4ModelDesignPolicy implements ComponentDesignPolicy {
  @override
  Widget showComponentBody(ComponentData componentData) {
    return Container(
      decoration: BoxDecoration(
        color: (componentData.data as C4ModelData).color,
        border: Border.all(
          width: 2,
          color: (componentData.data as C4ModelData).isHighlightVisible
              ? Colors.pink
              : Colors.black,
        ),
      ),
...
mixin C4CanvasPolicy implements CanvasPolicy, CustomPolicy {
  @override
...
mixin C4ComponentPolicy implements ComponentPolicy, CustomPolicy {
...
mixin CustomPolicy implements PolicySet {
  ...
  deserialize() {
    ...
    canvasWriter.model.deserializeDiagram(
      serializedDiagram,
      decodeCustomComponentData: (json) => C4ModelData.fromJson(json),
